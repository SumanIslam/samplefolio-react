...
export const projectsData = [
	...
	},
	{
		...
		description2:
			"It's built with React and Redux. The backend is served by Firebase, payments are handled by Stripe API, Login with OAuth and email. This is fully responsive site styled with styled-component. Also used little bit Node for handling payment.",
	...
	},
	{
		...
		description2:
			"It's built with React. The color shade is served by Chroma js, Plenty of library used such as emoji-mart, React color for color-picker, react-copy-to-clipboard for copy on click, react-material-ui-form-validator, react-transition-group for animation. Styling was done by Material-UI and CSS-in-JS",
		stack: [
			'React',
			'Material UI',
			'CSS-in-JS',
